...
<?php if (('open' == $post-> comment_status) && ('open' == $post->ping_status)) : ?>
					<?php printf(__('<a href="#respond" title="Post a comment">Post a comment</a>, <a href="%s" rel="trackback" title="Trackback URL for your post">trackback URL</a>.', 'fcstandard2014'), get_trackback_url()) ?>
<?php elseif (!('open' == $post-> comment_status) && ('open' == $post->ping_status)) : ?>
					<?php printf(__('Comments are closed, <a href="%s" rel="trackback" title="Trackback URL for your post">trackback URL</a>.', 'fcstandard2014'), get_trackback_url()) ?>
<?php elseif (('open' == $post-> comment_status) && !('open' == $post->ping_status)) : ?>
					<?php printf(__('Trackbacks are closed, but you can <a href="#respond" title="Post a comment">post a comment</a>.', 'fcstandard2014')) ?>
<?php elseif (!('open' == $post-> comment_status) && !('open' == $post->ping_status)) : ?>
					<?php _e('Both comments and trackbacks are currently closed.', 'fcstandard2014') ?>
<?php endif; ?>

<?php edit_post_link(__('Edit this entry.', 'fcstandard2014'),'',''); ?>
				</div>
			</div><!-- .post -->
